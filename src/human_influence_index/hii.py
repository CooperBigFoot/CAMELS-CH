...
def main():
    ...
    for region in regions:
        ...
        config = CaravanifyConfig(
            attributes_dir=f"/workspace/CARAVANIFY/{region}/post_processed/attributes",
            timeseries_dir=f"/workspace/CARAVANIFY/{region}/post_processed/timeseries/csv",
