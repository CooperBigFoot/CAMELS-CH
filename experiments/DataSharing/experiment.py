...
from src.experiment_framework.model_utils import load_model_configs_from_yaml
...
from experiments.DataSharing.utils import create_country_run_name
...
def main():
    ...
    for country in args.countries:
        ...
        for model_type in args.models:
            ...
            (dirs["checkpoints"] / country_lower / model_type).mkdir(parents=True, exist_ok=True)
            (dirs["logs"] / country_lower / model_type).mkdir(parents=True, exist_ok=True)
    ...
    for country in args.countries:
        ...
        try:
            ...
            model_configs = load_model_configs_from_yaml(yaml_paths, args.models)
            ...
            for model_type in args.models:
                ...
                # Create and train the model using framework utility
                train_model(
            ...
            logger.error(f"Error processing {country} scenario: {str(e)}", exc_info=True)
