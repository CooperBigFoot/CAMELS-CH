...
def parse_args():
    ...
    parser.add_argument(
        "--tide-yaml",
        type=str,
        default="configs/best_params/tide_params.yaml",
    ...
    parser.add_argument(
        "--tsmixer-yaml",
        type=str,
        default="configs/best_params/tsmixer_params.yaml",
    ...
    parser.add_argument(
        "--ealstm-yaml",
        type=str,
        default="configs/best_params/ealstm_params.yaml",
    ...
    parser.add_argument(
        "--tft-yaml",
        type=str,
        default="configs/best_params/tft_params.yaml",
