"""Configuration file for TFT models in the Data Sharing experiment."""
import sys
...
class TFTModelConfig:
    """Configuration for TFT models in the data sharing experiment."""
    ...
    def get_model_config(self, 
                         ...
                         input_size: int, 
                         static_size: int,
                         future_input_size: int) -> TFTConfig:
        """Create a TFTConfig with hyperparameters from YAML.
        ...
        Returns:
            TFTConfig object configured for the experiment
        """
    ...
    def create_model(self, 
                    ...
                    input_size: int, 
                    static_size: int,
                    future_input_size: int) -> LitTFT:
        """Create a LitTFT model instance with proper configuration.
