"""Configuration file for TSMixer models in the Data Sharing experiment."""
import sys
...
@dataclass
class TSMixerModelConfig:
    """Configuration for TSMixer models in the data sharing experiment."""
    ...
    def get_model_config(self, 
                         ...
                         input_size: int, 
                         static_size: int,
                         future_input_size: int) -> TSMixerConfig:
        """Create a TSMixerConfig with hyperparameters from YAML.
        ...
        Returns:
            TSMixerConfig object configured for the experiment
        """
    ...
    def create_model(self, 
                    ...
                    input_size: int, 
                    static_size: int,
                    future_input_size: int) -> LitTSMixer:
        """Create a LitTSMixer model instance with proper configuration.
