"""Configuration file for EALSTM models in the Data Sharing experiment."""
import sys
...
@dataclass
class EALSTMModelConfig:
    """Configuration for EALSTM models in the data sharing experiment."""
    ...
    def get_model_config(self, 
                         ...
                         input_size: int, 
                         static_size: int,
                         future_input_size: int) -> EALSTMConfig:
        """Create an EALSTMConfig with hyperparameters from YAML.
        ...
        Returns:
            EALSTMConfig object configured for the experiment
        """
    ...
    def create_model(self, 
                    ...
                    input_size: int, 
                    static_size: int,
                    future_input_size: int) -> LitEALSTM:
        """Create a LitEALSTM model instance with proper configuration.
