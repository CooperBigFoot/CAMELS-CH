"""Train models on Kyrgyzstan data only."""
import os
import sys
...
def train_kyrgyzstan_models(
    ...
    for model_type in model_types:
        ...
        # Prepare model-specific datamodule for Kyrgyzstan data
        logger.info(f"Preparing {model_type}-specific datamodule for {SCENARIO} with {len(kgz_ids)} basins")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train models on Kyrgyzstan data")
    parser.add_argument(
        "--models", 
        nargs="+", 
