"""Train models on Tajikistan data only."""
import os
import sys
...
def train_tajikistan_models(
    ...
    for model_type in model_types:
        ...
        # Prepare model-specific datamodule for Tajikistan data
        logger.info(f"Preparing {model_type}-specific datamodule for {SCENARIO} with {len(tjk_ids)} basins")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train models on Tajikistan data")
    parser.add_argument(
        "--models", 
        nargs="+", 
