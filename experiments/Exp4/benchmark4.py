...
import pandas as pd
from experiments.Exp4.config4 import ExperimentConfig
...
class BenchmarkRunner:
    ...
    def setup_directories(self):
        ...
        self.results_dir = Path("experiments/Exp4/results")
        self.model_dir = Path("experiments/Exp4/saved_models")
        self.checkpoint_dir = Path("experiments/Exp4/checkpoints")
