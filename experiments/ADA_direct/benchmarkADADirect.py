...
class BenchmarkRunner:
    ...
    def visualize_domain_adaptation(self, trained_model, source_dm, target_dm, run):
        ...
        da_model = LitTSMixerDomainAdaptation(self.config.get_domain_adaptation_config())
        ...
        missing_keys, unexpected_keys = da_model.load_state_dict(da_state_dict, strict=False)
    ...
    def save_aggregated_results(self, all_results):
        ...
        try:
            ...
            summary_stats.to_csv(self.results_dir /
                                 f"benchmark_aggregate_metrics.csv")
